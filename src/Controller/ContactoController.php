...
{
    private $contactos = [
        1 => ["nombre" => "Juan Pérez", "telefono" => "524142432", "email" => "juan@ieselcaminas.org"],
    ...
    public function insertarConProvincia(ManagerRegistry $doctrine): Response{
        ...
        $contacto->setTelefono("695438702");
    ...
    public function insertarSinProvincia(ManagerRegistry $doctrine): Response{
        ...
        $contacto->setTelefono("745498702");
    ...
    //Lo comentamos porque ya es obsoleto
    /*
    ...
    //ficha_contacto VA AL FINAL o no tirá
